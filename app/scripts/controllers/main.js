(function(){	
  ...
  .controller('MainCtrl',['$scope','$q','MainService','Notification','$timeout',function($scope,$q,MainService,Notification,$timeout){
    var mainVm = this;
    mainVm.loading = true;  
    mainVm.unitOfCurr = 1;
    mainVm.currentDate = new Date();
     ...
     var assignData = function assignData(result,history){
